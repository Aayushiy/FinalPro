...
class App:
    def __init__(self):
        ...
        self.bfs_button = Buttons(self, WHITE, 50, MAIN_BUTTON_Y_POS, MAIN_BUTTON_LENGTH, MAIN_BUTTON_HEIGHT, 'Breadth First Search')
        self.dfs_button = Buttons(self, WHITE, 300, MAIN_BUTTON_Y_POS, MAIN_BUTTON_LENGTH, MAIN_BUTTON_HEIGHT, 'Depth First Search')
        self.astar_button = Buttons(self, WHITE, 550, MAIN_BUTTON_Y_POS, MAIN_BUTTON_LENGTH, MAIN_BUTTON_HEIGHT, 'A Star Search')
        self.dijkstra_button = Buttons(self, WHITE, 800, MAIN_BUTTON_Y_POS, MAIN_BUTTON_LENGTH, MAIN_BUTTON_HEIGHT, 'Dijkstra Search')
        self.bidirectional_button = Buttons(self, WHITE, 1050, MAIN_BUTTON_Y_POS, MAIN_BUTTON_LENGTH, MAIN_BUTTON_HEIGHT, 'Bidirectional Search')

        # Define Grid-Menu buttons
        self.start_end_node_button = Buttons(self, WHITE, 30, START_END_BUTTON_HEIGHT, GRID_BUTTON_LENGTH, GRID_BUTTON_HEIGHT, 'Start/End Node')
        self.wall_node_button = Buttons(self, WHITE, 30, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT + BUTTON_SPACER, GRID_BUTTON_LENGTH, GRID_BUTTON_HEIGHT, 'Wall Node')
        self.reset_button = Buttons(self, WHITE, 30, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT*2 + BUTTON_SPACER*2, GRID_BUTTON_LENGTH, GRID_BUTTON_HEIGHT, 'Reset')
        self.start_button = Buttons(self, WHITE, 30, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT*3 + BUTTON_SPACER*3, GRID_BUTTON_LENGTH, GRID_BUTTON_HEIGHT, 'Visualize Path')
        self.main_menu_button = Buttons(self, WHITE, 30, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT * 4 + BUTTON_SPACER * 4, GRID_BUTTON_LENGTH, GRID_BUTTON_HEIGHT, 'Main Menu')
        self.maze_generate_button = Buttons(self, WHITE, 30, START_END_BUTTON_HEIGHT + GRID_BUTTON_HEIGHT * 5 + BUTTON_SPACER * 5, GRID_BUTTON_LENGTH, GRID_BUTTON_HEIGHT, 'Generate Maze')
    def run(self):
        while self.running:
...
##### Setup for Main Menu
    def sketch_main_menu(self):
        self.screen.blit(self.main_menu_background, (-170,80))
...
##### MAIN MENU FUNCTIONS
    ...
    def main_menu_events(self):
        ...
        self.draw_text('Made By: Aayushi & Ananya',self.screen, [1200, 720], 8, WHITE, FONT, centered=False)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEMOTION:
                if self.bfs_button.isOver(pos):
                    ...
                    self.dfs_button.colour = WHITE
                elif self.astar_button.isOver(pos):
                    self.astar_button.colour = WHITE
                elif self.dijkstra_button.isOver(pos):
                    self.dijkstra_button.colour = WHITE
                elif self.bidirectional_button.isOver(pos):
                    self.bidirectional_button.colour = WHITE
                else:
    ...
    def execute_search_algorithm(self):
        ...
        if self.algorithm_state == 'bfs':
            ...
            if self.bfs.route_found:
                ...
                self.draw_text('NO ROUTE FOUND!', self.screen, [768,384], 8, RED, FONT, centered = True)
        ...
        ### DFS ###
            ...
            if self.dfs.route_found:
                ...
                self('NO ROUTE FOUND!', self.screen, [768,384], 8, RED, FONT, centered = True)
        ...
        ### A-STAR ###
            ...
            if self.astar.route_found:
                ...
                self.draw_text('NO ROUTE FOUND!', self.screen, [768, 384], 14, RED, FONT, centered=True)
